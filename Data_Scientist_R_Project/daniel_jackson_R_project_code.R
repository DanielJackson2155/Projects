...
# Set working director to where data is 
setwd("/Users/doojerthekid/Documents/Merrimack Grad School Documents/DSE5002")
data_csv <- read.csv("Data_Scientist_R_Project/data.csv"
